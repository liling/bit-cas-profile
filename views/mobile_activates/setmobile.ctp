<div id="column3">
    ...
    <div class="box form">
        ...
        <div class="footer">
            <?php echo $form->button(__('发送确认码', true), array('type' => 'submit')); ?>
        </div>
        <?php echo $form->end(); ?>

        <?php else: ?>
        <?php echo $form->create('MobileActivate', array('action' => 'clear')); ?>
            <?php echo $form->button(__('重新设定', true), array('type' => 'submit', 'style' => 'float: right')); ?>
        <?php echo $form->end(); ?>

        <div class="header"><?php echo $title_for_layout; ?> - <?php __('输入确认码'); ?></div>
        ...
        <?php echo $form->create('MobileActivate', array('action' => 'resend')); ?>
            ...
            <?php echo $form->button(__('重新发送确认码', true), array('type' => 'submit', 'disabled' => !empty($no_more_send))); ?>
        <?php echo $form->end(); ?>

        <?php echo $form->create('MobileActivate', array('action' => 'confirm')); ?>
        <div class="item">
            <label for="code"><?php __('输入确认码:') ?></label>
...
<div id="column4" class="description">
    <?php echo $this->element("languages/$locale/setmobile_description"); ?>
</div>
